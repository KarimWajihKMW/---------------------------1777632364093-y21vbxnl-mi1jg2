...
function ownerLoginPage() {
  return shell('دخول لوحة المالك', 'صفحة خاصة لإدارة البرامج والاشتراكات والمنتجات والعبارات والدعم. اسم المستخدم الافتراضي هو admin وكلمة المرور الأولية تُحدد عبر متغير OWNER_INITIAL_PASSWORD أو يتم توليدها وطباعتها في سجل تشغيل الخادم عند أول تهيئة.', `
